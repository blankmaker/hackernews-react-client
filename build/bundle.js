...
/***/ function(module, exports, __webpack_require__) {
	...
	var hackerAPI = new _firebase2['default']('https://hacker-news.firebaseio.com/v0/topstories');
	...
	var App = (function (_React$Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      var stuff = undefined;
	      hackerAPI.once('value', function (values) {
	        stuff = values.val();
	        if (_reactDom2['default'].findDOMNode(_this)) {
	          _this.setState({ ids: stuff });
	        }
	      });
	    }
	  }, {
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement('div', null, _react2['default'].createElement('p', null, 'Welcome? to the beginnings of Hacker News. Let build.'));
	    }
	  }]);
